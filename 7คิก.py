...
# ----------------- NOTIFED MEMBER JOIN GROUP
        if op.type == 17:
          if wait["group"] == True:
            ...
            contact = cl.getContact(op.param2)
            image = "http://dl.profile.line-cdn.net/" + contact.pictureStatus
            cl.sendText(op.param1, " ยินดีต้อนรับ. เข้ามาแล้วก็อย่าลืมทักกันน่ะครับ @ " + cl.getContact(op.param2).displayName + " สู่กลุ่ม " + "👉" + str(ginfo.name) + "👈""\nหรือสนใจลงบอทป้องกัน , บอทแท็ก ติดต่อได้ที่Line ID : Kmzaaa\nhttp://line.me/ti/p/eOuAF1hhYx")
              ...
              if msg.from_ in admin:
                if wait["inviteprotect"] == False:
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"✨ล็อค���ชิญปิด✨")
                else:
...
#----------------------------------------------------------------------
                ...
                if wait["lang"] == "JP":
                    ...
                    ki5.sendText(msg.to,"Completion。")
                    ki6.sendText(msg.to,"Completion。")
                    ki7.sendText(msg.to,"💟ทำการลบห้องรันหมดแล้ว💟")
                else:
